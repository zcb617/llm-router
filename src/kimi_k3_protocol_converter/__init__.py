...
All Kimi K3 protocol conversion logic lives in the submodule; this package
simply re-exports it for llm_router.
"""
import sys
...
import kimi_k3_protocol_converter as _mod  # noqa: E402

...
def test_registry_returns_physically_separate_kimi_converters():
    ...
    kimi27 = get_protocol_converter("kimi2.7")
    kimi3 = get_protocol_converter("kimi3")

    assert kimi26 is not kimi27
    assert kimi27 is not kimi3
    assert kimi26 is not kimi3
    assert kimi26.StreamConverter is not kimi27.StreamConverter
    assert kimi27.StreamConverter is not kimi3.StreamConverter
    ...
    assert "kimi_k27_protocol_converter" in kimi27.StreamConverter.__module__
